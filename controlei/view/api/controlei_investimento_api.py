...
from ...model.facade.controlei_investimento_facade import (
    ControleiInvestimentoFacade as inv_f
)
# ---------------------------->>
# NameSpace
# ---------------------------->>

api = Namespace('controlei-investimento',
                description='Tabela de investimentos de usuário')
...
class ControleiMeioPagamento(Resource):
    ...
    def get(self):
        ...
        result = inv_f().obter_investimento(
